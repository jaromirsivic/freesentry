"""Centralised logging configuration for the XTX package.

All modules acquire loggers via :func:`get_logger`; production code never uses
``print``. Logging is configured once, idempotently, on first import.
"""
...
def configure_logging(*, level: int = logging.INFO) -> None:
    """Install a single stream handler on the root ``xtx`` logger.
