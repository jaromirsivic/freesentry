"""OKS-based keypoint evaluation: AP, AP50, AP75, AR (spec sections 9.2, 14.7).

A pragmatic COCO-style keypoint evaluator. For each image, detections are matched to
ground-truth people greedily by descending score across a range of OKS thresholds
(0.50..0.95 step 0.05). Average Precision is integrated over recall; AP is the mean
across thresholds, AP50/AP75 are the single-threshold values, and AR is the mean
maximum recall across thresholds.
"""
