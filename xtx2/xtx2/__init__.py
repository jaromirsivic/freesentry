"""XTX2 Pose: extremely fast 3-level centre-focused human pose estimation.

Public API (spec section 2)::

    from xtx2 import load_model, detect_poses, detect_poses_batch, Pose
...
def __getattr__(name: str) -> Any:
    ...
    raise AttributeError(f"module 'xtx2' has no attribute {name!r}")
