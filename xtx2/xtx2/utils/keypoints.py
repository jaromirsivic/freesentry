...
Single source of truth for keypoint order (spec section 7.1), left/right flip
pairs (section 8.5), skeleton edges (section 10.1), and OKS sigmas (section 7.3).
"""
...
# Index pairs whose values must be swapped on a horizontal flip (section 8.5).
...
# COCO per-keypoint sigmas (section 7.3): OKS metric, merge matching, OKS loss.
...
# Skeleton edges for visualisation (COCO convention, 0-based).
