...
class VarifocalLoss(nn.Module):
    """Varifocal classification loss (IoU-aware BCE weighting), spec section 7.4."""
    ...
    def forward(self, pred_logits: torch.Tensor, target_score: torch.Tensor) -> torch.Tensor:
