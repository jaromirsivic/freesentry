"""PAN/FPN neck: top-down then bottom-up fusion.

Fuses {P3, P4, P5} (and optionally P2 for small-person emphasis, XTX3-l only)
and emits one feature map per pyramid level to the detection head. CSPBlock
fusion is applied at every merge point.
"""
